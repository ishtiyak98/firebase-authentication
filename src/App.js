...
//!------------- Handle Registered State -----------------
  ...
  return (
    <div className='h-screen flex justify-center items-center bg-gray-100 text-gray-800'>
      <div className='w-4/5 md:w-1/2 lg:w-1/3'>
        <div className='bg-white border-l-8 border-l-indigo-600 rounded-md px-8 py-6'>
